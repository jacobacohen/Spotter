...
// And https://www.raywenderlich.com/165853/menus-popovers-menu-bar-apps-macos
...
class ViewController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        theMenu.addItem(withTitle: "Volume Up", action: #selector(volumeUp), keyEquivalent: String(NSUpArrowFunctionKey))
        theMenu.addItem(withTitle: "Volume Down", action: #selector(volumeDown), keyEquivalent: String(NSDownArrowFunctionKey))
